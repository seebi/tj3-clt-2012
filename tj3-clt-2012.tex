...
\begin{frame}[fragile]{Other resources such as tools}
  \begin{itemize}
    \item The tool never sleeps but also does not work
      \begin{semiverbatim}
        \begin{lstlisting}
...
\begin{frame}{Project Management Cycle}
  After starting the project, the following tasks should be re-run on a regularly:
  \begin{itemize}
...
\begin{frame}{{\tt timesheets} and {\tt statussheets}}
  \begin{itemize}
    ...
    \item This topic is too much complex for this slides but is documented
...
\begin{frame}{Track Key Values with {\tt tracereport}}
  \begin{itemize}
    \item With {\tt tracereports} you can track important key values over the whole projects lifetime.
